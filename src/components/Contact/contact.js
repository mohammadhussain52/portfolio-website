  ...
  return (
   <section id='contact'>
    ...
    <div id='contact'>
        ...
        <p className='contactpage-description'>Feel free to reach out if you're looking to hire a developer</p>
        <form className='contact-form' ref={form} onSubmit={sendEmail}>
            ...
            <input type='Subject' className='subject' placeholder='I would like to discuss' name='your_subject'></input>
            <textarea className='message' name='message' rows={5} placeholder='Write Your Message'></textarea>
            <button type='submit' value='Send' className='submit-btn'>Submit</button>
            <div className='social-links'>
                <a href='mailto: mh575390@gmail.com'> <FaEnvelope className='social-icon'>Email</FaEnvelope></a>
                <a href='https://wa.me/923322467774'><FaWhatsapp className='social-icon'>Whatsapp</FaWhatsapp></a>
                <a href='https://github.com/mohammadhussain52'><FaGithub className='social-icon'>Github</FaGithub></a> 
                <a href='https://www.linkedin.com/in/mohammad-hussain-769610281/'><FaLinkedin className='social-icon'>Linkedin</FaLinkedin></a>
            </div>
        </form>
    </div>
   </section>
